...
import stacking from '../../assets/Staking.png'
  ...
  return (
    <>
      <div className="staking mb-5">
        <div className="stack-bg mb-lg-0 mb-5">

      <div className="container">
            <div className="row">
                <div className="col-lg-6 col-sm-12 mt-lg-5">
                    <h1 className='home_heading mt-lg-5'>
                    Secure the Virtual <span className="responsive sma" style={{background: "#ffa252"}}>STAKING
</span>
                    </h1>
                </div>
                <div className="col-lg-6 col-sm-12">
      <img className='groot mt-lg-0 mt-5 responsive' src={stacking} alt="" />
        ...
        <Container>
          <Row className="mt-5  ">
            ...
            <Col xs={12} sm={12} md={12} lg={8}>
              ...
              {/* <div> */}
              <div className="lower_bsc_table back  mt-5 mb-lg-0 mb-4">
