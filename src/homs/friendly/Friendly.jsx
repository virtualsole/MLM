    ...
    <div className="container">
        <div className="row">
            <div className="col-lg-6 col-sm-12 mt-lg-0 mt-5">
                ...
                <p className='eco_p mt-lg-3'>Staking is a greener and more sustainable way to secure the blockchain. Using Virtual, you can earn rewards for your service to its network and ecosystem.</p>
            </div>
